...
enum AMGLConstant : enum_t
{
    ...
    AMGL_TEXTURE_CUBE_MAP_POSITIVE_X        = 0x8515,
    AMGL_TEXTURE_CUBE_MAP_NEGATIVE_X        = 0x8516,
    AMGL_TEXTURE_CUBE_MAP_POSITIVE_Y        = 0x8517,
    AMGL_TEXTURE_CUBE_MAP_NEGATIVE_Y        = 0x8518,
    AMGL_TEXTURE_CUBE_MAP_POSITIVE_Z        = 0x8519,
    AMGL_TEXTURE_CUBE_MAP_NEGATIVE_Z        = 0x851A,
