...
//     //     constexpr type_arithmetic() : value(0) {}
//     //     constexpr type_arithmetic(type value) : value(value) {}
        
//     //     static constexpr size_t COMPONENTS_COUNT = 1;

//     //     static inline constexpr type max_value() noexcept { return math::max_value<type>(); }
//     //     static inline constexpr type min_value() noexcept { return math::min_value<type>(); }

//     //     operator type() noexcept { return value; }
//     //     operator type&() noexcept { return value; }
...
//     //     static constexpr size_t COMPONENTS_COUNT = 4;
        
//     //     static inline constexpr type a_max() noexcept { return math::max_bit_value<type>(A_BITS_COUNT); }
//     //     static inline constexpr type a_min() noexcept { return math::min_bit_value<type>(A_BITS_COUNT); }
//     //     static inline constexpr type b_max() noexcept { return math::max_bit_value<type>(B_BITS_COUNT); }
//     //     static inline constexpr type b_min() noexcept { return math::min_bit_value<type>(B_BITS_COUNT); }
//     //     static inline constexpr type g_max() noexcept { return math::max_bit_value<type>(G_BITS_COUNT); }
//     //     static inline constexpr type g_min() noexcept { return math::min_bit_value<type>(G_BITS_COUNT); }
//     //     static inline constexpr type r_max() noexcept { return math::max_bit_value<type>(R_BITS_COUNT); }
//     //     static inline constexpr type r_min() noexcept { return math::min_bit_value<type>(R_BITS_COUNT); }
...
//     // using type_byte                 = type_arithmetic<int8_t>;
//     // using type_ubyte                = type_arithmetic<uint8_t>;
//     // using type_short                = type_arithmetic<int16_t>;
//     // using type_ushort               = type_arithmetic<uint16_t>;
//     // using type_int                  = type_arithmetic<int32_t>;
//     // using type_uint                 = type_arithmetic<uint32_t>;
//     // using type_float                = type_arithmetic<float>;
//     // using type_double               = type_arithmetic<double>;
