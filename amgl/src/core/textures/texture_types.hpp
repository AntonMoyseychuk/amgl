...
namespace amgl
{
    ...
    using type_uint_10f_11f_11f_rev = fmt_bgr_t<uint32_t, 10, 11, 11, 0>;
    ...
    using type_ubyte_3_3_2_rev      = fmt_bgr_t<uint8_t, 3, 3, 2, 0>;
    ...
    static_assert(sizeof(type_uint_10f_11f_11f_rev) == 4u, "invalid type_uint_10f_11f_11f_rev size");
    ...
    static_assert(sizeof(type_ubyte_3_3_2_rev)      == 1u, "invalid type_ubyte_3_3_2_rev size");
    ...
    static constexpr inline size_t get_type_size(enum_t type) noexcept
    {
        switch (type) {
            ...
            case AMGL_UNSIGNED_INT_10F_11F_11F_REV: return sizeof(type_uint_10f_11f_11f_rev);
